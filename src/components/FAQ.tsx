...
const FAQ = () => {
  const faqs = [
    {
      question: "Czy moje dziecko potrzebuje wcześniejszego doświadczenia?",
    ...
    },
    {
      ...
      answer: "Oferujemy darmowy trial na 14 dni, po którym dostępne są różne pakiety: tylko online (99 zł/miesiąc), hybrydowy z 2 warsztatami miesięcznie (199 zł/miesiąc), lub premium z nieograniczonymi warsztatami (299 zł/miesiąc). Wszystkie ceny zawierają dostęp do pełnej platformy i materiałów."
    },
    {
    ...
    {
      question: "Co jeśli dziecko jest młodsze/starsze niż zakres 6-14 lat?",
      answer: "Dla dzieci 5-letnich oferujemy specjalny program wprowadzający z jeszcze prostszymi zagadnieniami. Dla starszych (14+) mamy zaawansowane kursy z bardziej skomplikowanymi projektami i przygotowaniem do olimpiad technicznych. Skontaktuj się z nami, aby omówić indywidualne potrzeby."
    }
  ];
