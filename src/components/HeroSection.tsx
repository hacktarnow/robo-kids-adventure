        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-primary">Nauka przez zabawę!</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight">
              Odkryj Świat{" "}
              <span className="text-gradient">Robotyki</span>{" "}
              i Programowania
            </h1>
            
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl">
              Gamifikowana platforma edukacyjna dla dzieci 6-14 lat. Rozwijaj kompetencje 
              inżynieryjne przez gry, eksperymenty i warsztaty online!
            </p>
            ...
            <div className="flex items-center gap-8 justify-center lg:justify-start pt-4">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Warsztatów</div>
              </div>
              <div className="text-center">
