            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto">
                        Dołącz do ponad 10,000 szczęśliwych dzieci, które
                        odkrywają świat technologii przez zabawę i praktyczne
                        projekty. Bez zobowiązań, bez karty kredytowej.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="bg-transparent border-2 border-secondary text-secondary hover:bg-secondary hover:text-primary text-lg px-8 py-6 rounded-full hover-lift"
                        >
